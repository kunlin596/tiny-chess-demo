...
class EntityCreator(object):
    ...
    def create_chess_pieces(self, piece_entities, tile_entities):
        ...
        for i in range(8):
            piece_entities[1][i] = self.create_piece(
                1,
                i,
                CHESS_PAWN_MODEL_INDEX,
                color_black,
                tile_entities,
                select_color1,
                PLAYER_BLACK,
            )
            piece_entities[6][i] = self.create_piece(
                6,
                i,
                CHESS_PAWN_MODEL_INDEX,
                color_white,
        ...
        piece_entities[0][0] = self.create_piece(
            0,
            0,
            CHESS_TOWER_MODEL_INDEX,
            color_black,
            tile_entities,
            select_color1,
            PLAYER_BLACK,
        )
        piece_entities[0][1] = self.create_piece(
            0,
            1,
            CHESS_KNIGHT_MODEL_INDEX,
            color_black,
            tile_entities,
            select_color1,
            PLAYER_BLACK,
        )
        piece_entities[0][2] = self.create_piece(
            0,
            2,
            CHESS_BISHOP_MODEL_INDEX,
            color_black,
            tile_entities,
            select_color1,
            PLAYER_BLACK,
        )
        piece_entities[0][3] = self.create_piece(
            0,
            3,
            CHESS_KING_MODEL_INDEX,
            color_black,
            tile_entities,
            select_color1,
            PLAYER_BLACK,
        )
        piece_entities[0][4] = self.create_piece(
            0,
            4,
            CHESS_QUEEN_MODEL_INDEX,
            color_black,
            tile_entities,
            select_color1,
            PLAYER_BLACK,
        )
        piece_entities[0][5] = self.create_piece(
            0,
            5,
            CHESS_BISHOP_MODEL_INDEX,
            color_black,
        ...
        piece_entities[0][6] = self.create_piece(
            0,
            6,
            CHESS_KNIGHT_MODEL_INDEX,
            color_black,
        ...
        piece_entities[0][7] = self.create_piece(
            0,
            7,
            CHESS_TOWER_MODEL_INDEX,
            color_black,
        ...
        piece_entities[7][0] = self.create_piece(
            7,
            0,
            CHESS_TOWER_MODEL_INDEX,
            color_white,
        ...
        piece_entities[7][1] = self.create_piece(
            7,
            1,
            CHESS_KNIGHT_MODEL_INDEX,
            color_white,
        ...
        piece_entities[7][2] = self.create_piece(
            7,
            2,
            CHESS_BISHOP_MODEL_INDEX,
            color_white,
        ...
        piece_entities[7][3] = self.create_piece(
            7,
            3,
            CHESS_KING_MODEL_INDEX,
            color_white,
        ...
        piece_entities[7][4] = self.create_piece(
            7,
            4,
            CHESS_QUEEN_MODEL_INDEX,
            color_white,
        ...
        piece_entities[7][5] = self.create_piece(
            7,
            5,
            CHESS_BISHOP_MODEL_INDEX,
            color_white,
        ...
        piece_entities[7][6] = self.create_piece(
            7,
            6,
            CHESS_KNIGHT_MODEL_INDEX,
            color_white,
        ...
        piece_entities[7][7] = self.create_piece(
            7,
            7,
            CHESS_TOWER_MODEL_INDEX,
            color_white,
